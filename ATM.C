...
void staticmembers()
{
    ob[0].accno = 99011;
    ob[0].pin = 1256;
    strcpy(ob[0].name, "Vivek");
    strcpy(ob[0].surname, "Kushwah");
    ob[0].amt = 66000;

    ob[1].accno = 99012;
    ob[1].pin = 1257;
    strcpy(ob[1].name, "Abhishek");
    strcpy(ob[1].surname, "Gupta");
    ob[1].amt = 78000;

    ob[2].accno = 99013;
    ob[2].pin = 1258;
    strcpy(ob[2].name, "Anshul");
    strcpy(ob[2].surname, "Gour");
    ob[2].amt = 75000;
    ...
    ob[4].accno = 99015;
    ob[4].pin = 1260;
    strcpy(ob[4].name, "Priyanshu");
    strcpy(ob[4].surname, "verma");
    ob[4].amt = 49000;
}
